  ...
  <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#e0f7fa] via-[#f0fdfa] to-[#fafff9] relative overflow-hidden p-4 sm:p-6">
    ...
    <div className="w-full max-w-md bg-white/95 rounded-3xl shadow-2xl p-8 sm:p-10 border border-white/50 relative z-10 backdrop-blur-xl">
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#4db8a8] to-[#3d9888] tracking-tight mb-2">เข้าสู่ระบบ</h2>
        <p className="text-sm text-gray-600">
          ยินดีต้อนรับกลับเข้าสู่ <span className="font-bold text-[#4db8a8]">Balanz.IA</span>
        </p>
      </div>
      {children}
    </div>
    ...
    <AuthCard>
        ...
        <div className="group">
          ...
          <div className="mt-2 text-right">
            <Link
              ...
              className="text-sm font-semibold text-[#4db8a8] hover:text-[#3d9888] hover:underline transition-all inline-flex items-center gap-1"
            >
              ลืมรหัสผ่าน?
      ...
      <div className="text-center mt-8">
        <p className="text-gray-600 text-sm">
          ยังไม่มีบัญชีใช่ไหม?
          <Link href="/register" className="text-[#4db8a8] hover:text-[#3d9888] font-bold ml-1 transition-all hover:underline inline-flex items-center gap-1">
            สมัครสมาชิก
